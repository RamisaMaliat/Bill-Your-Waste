        ...
        <dl className="dictionary">
            {posts.map(post => (
                <div className="term" style={{ "fontSize": "16px" }}>
                    ...
                    <dd><b>{"Sent to" + " " + ":" + " " + " "}</b>{post.full_address}</dd>
...
const ViewDashboard = () => {
    ...
    useEffect(() => {
        const fetchPosts = async () => {
            ...
            const res = await axios.get(process.env.REACT_APP_API + 'consumer/received',
                {
                    headers: {
            ...
            <app>
                ...
                <div class="container" style={{ "height": "100px" }} >
                    ...
                    <ul class="nav nav-tabs">
                        <li role="presentation" class="active" style={{ "paddingRight": "40px" }}><a style={{ "color": "green" }}>Received by you</a></li>
                        <li role="presentation" style={{ "paddingRight": "40px" }}><a href="not-received" style={{ "color": "green" }}>Not yet received</a></li>
                    </ul>
                </div>
