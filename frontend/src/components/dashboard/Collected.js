        ...
        <dl className="dictionary">
            {posts.map(post => (
                <div className="term" style={{"fontSize":"16px"}}>
                    ...
                    <dd><b>{"Picked from" + " " + ":" + " " + " "}</b>{post.full_address}</dd>
...
const ViewDashboard = () => {
    ...
    useEffect(() => {
        const fetchPosts = async () => {
            ...
            const res = await axios.get(process.env.REACT_APP_API + 'merchant/collected',
                {
                    headers: {
            ...
            <app>
                ...
                <span style={{"float": "right",  "fontSize":"103%"}}><u><b>Total Received: {res2} Tk.</b></u></span>
                    <ul class="nav nav-tabs">
                        <li role="presentation" class="active" style={{ "paddingRight": "40px" }}><a style={{ "color": "green" }}>Collected from you</a></li>
                        <li role="presentation" style={{ "paddingRight": "40px" }}><a href="not-collected" style={{ "color": "green" }}>Not yet collected</a></li>
                    </ul>
                </div>
