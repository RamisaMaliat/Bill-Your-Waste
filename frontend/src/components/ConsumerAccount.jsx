...
import Header5 from "../subComponents/Header5";
...
const ViewAccount = () => {
    ...
    useEffect(() => {
        const fetchPosts = async () => {
            ...
            const res = await axios.get(process.env.REACT_APP_API + 'consumer/account',
                {
                    headers: {
