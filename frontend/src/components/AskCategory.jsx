...
class AskCategory extends Component {
  ...
  handleSubmit(event) {
    ...
    let path = "/take-service" + category
        ...
        <div class="center-block" id="ask-category-container" style={{ "padding": "10px", "marginTop": "30px", backgroundColor: "#ecffe6" }}>
          ...
          <div class="mt-4 mb-4 mx-auto rounded pt-4 " style={{ backgroundColor: "#ecffe6" }} >
            <div class="text-center col log-in-div" style={{ backgroundColor: "#ecffe6", "marginTop": "0px" }} >
              ...
              <h2 class="green-text"><b>Take Service</b></h2>
              <p class="lead" style={{ "color": "gray" }}><i>Send us waste metarials and earn money!</i></p>
              <hr />
            </div>
            ...
            <form class="needs-validation" novalidate onSubmit={this.handleSubmit}>
              ...
              <h3 class="d-flex justify-content-between align-items-center mb-3">
                <span class="green-text" style={{ "paddingBottom": "20px" }}>&nbsp; &nbsp; Select the category of the waste you want to send</span><i class="bi bi-bookmark-star-fill"></i>
              </h3>
              {items}
